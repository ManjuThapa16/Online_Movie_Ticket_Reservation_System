			...
			<div class="contact">
				...
				<form action="lib/user.php" enctype="multipart/form-data" method="post" name="frm_user" onsubmit="return validateForm(this)">
					...
					<ul class="forms">
						...
						<li class="inputfield"><input name="user_suburb" type="text" class="bar" required value="<?=$data[user_suburb]?>"/></li>
					</ul>
					<ul class="forms">
						<li class="txt">Post Code</li>
						<li class="inputfield"><input name="user_postcode" type="text" class="bar" required value="<?=$data[user_postcode]?>"/></li>
					</ul>
					<ul class="forms">
